 ...
 *  @TODO 隐藏键盘失去焦点/显示键盘屏幕滚动/onfocus="VirtualKeyboardToggle(this.id);"进一步封装
 */
...
function VirtualKeyboardToggle(element_id){
  VirtualKeyboard.show(element_id, 'softkey');
  VirtualKeyboard.switchLayout("US US");
  $("#kb_langselector,#kb_mappingselector,#copyrights").css("display", "none");
  $('#virtualKeyboard').css("margin-left","-325px");
}