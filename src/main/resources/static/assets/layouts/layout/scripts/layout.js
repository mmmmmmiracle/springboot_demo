...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        //选中的项目 arrow 变为 open
        $('.nav-item.active.open').children().first().children().last().addClass("open");
    ...
    var handleSidebarToggler = function () {       
        ...
        if (Cookies && Cookies.get('SIDEBAR_CLOSED') === '1' && App.getViewPort().width >= resBreakpointMd) {
            ...
            $('.user-welcome').hide();
            $('.user-name').hide();
            $('.user-information').css("pointer-events","none");//移除所有指针事件
            $('.img-circle').removeClass("img-circle-big");
            $('.img-circle').addClass("img-circle-small");
            $('.user-information').removeClass("user-information-higher");
            $('.user-information').addClass("user-information-lower");
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                $('.user-welcome').show();
                $('.user-name').show();
                $('.img-circle').removeClass("img-circle-small");
                $('.img-circle').addClass("img-circle-big");
                $('.user-information').removeClass("user-information-lower");
                $('.user-information').addClass("user-information-higher");
...
if (App.isAngularJsApp() === false) {
    jQuery(document).ready(function() {    
       Layout.init(); // init HYD Co.,Ltd core componets
    });
}